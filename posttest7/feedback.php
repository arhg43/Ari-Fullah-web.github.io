...
$sql = mysqli_query($conn, "SELECT * FROM daftar_pengisi_feedback WHERE nama LIKE '%$search%' OR gmail LIKE '%$search%'");
    ...
    <table class="table-feedback">
        <thead>
            <tr class="table-feedback-row">
                ...
                <th class="table-feedback-header">File</th>
        ...
        <tbody>
                ...
                <?php $i = 1; foreach ($feedbacks as $feedback): ?>
                    <tr class="table-feedback-row">
                        ...
                        <td class="table-feedback-data">
                            <?php if ($feedback['nama_file']): ?>
                                <a href="uploads/<?php echo htmlspecialchars($feedback['nama_file']); ?>" download>Unduh File</a>
                            <?php else: ?>
                                Tidak ada file
                            <?php endif; ?>
                        </td>
            ...
            <?php else: ?>
                <tr>
                    <td colspan="8" class="table-feedback-data">Tidak ada data tersedia.</td>
                </tr>
            <?php endif; ?>
        </tbody>
    </table>
